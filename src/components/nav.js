        ...
        <div id="main-menu" className="main-menu collapse navbar-collapse">
          <ul className="nav navbar-nav">
            ...
            <li className="menu-item-has-children dropdown">
              ...
              <ul className="sub-menu children dropdown-menu">
                <li>
                  ...
                  <NavLink to="/booktypes">Book Types</NavLink>
                </li>
                <li>
                  <i className="fa fa-table" />
            ...
            <li className="menu-item-has-children">
              <NavLink to="/authors">
                {" "}
                <i className="menu-icon fa fa-pencil-square" />
                Authors
              </NavLink>
            </li>
            <li className="menu-item-has-children ">
            ...
            {/* /.menu-title */}
            <li className="menu-item-has-children dropdown">
              <NavLink to="/users" aria-haspopup="true" aria-expanded="false">
                {" "}
            ...
            <li className="menu-item-has-children dropdown">
              <NavLink to="/borrows" aria-haspopup="true" aria-expanded="false">
                {" "}
                <i className="menu-icon fa fa-retweet" />
                Borrows
              </NavLink>
            </li>
          </ul>
