...
const validationSchema = yup.object().shape({
  type_name: yup
    ...
    .matches("^[a-zA-Z0-9 ]*$", "Type name not valid"),
});
                  ...
                  <div className="row form-group">
                    ...
                    <div className="col-12 col-md-9">
                      <Form.Control
                        ...
                        isInvalid={
                          props.touched.type_name && props.errors.type_name
                        }
                      />
