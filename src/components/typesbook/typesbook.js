...
export const TypeBookComponent = () => {
    ...
    const updated = useFormik({
        initialValues: {
            type_name: '',
        },
        onSubmit: (value) => {
            axios.put(`https://e-libraryapi.herokuapp.com/typebook/${typeBookDetail._id}`, {
                type_name: value.type_name
            }).then((response) => {
                if (response.status == 200) {
                    handleCloseEdit()
    ...
    return (
        <div className="content">
            ...
            <Modal show={showCreated} onHide={handleCloseCreate}>
                ...
                <Modal.Body>
                    <div className="card-body card-block" onSubmit ={handleSubmit}>
            ...
            <Modal show={showEdit} onHide={handleCloseEdit}>
                <Modal.Header closeButton>
                    <Modal.Title>Edit Type Book</Modal.Title>
                </Modal.Header>
                <Modal.Body>
