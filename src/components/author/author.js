...
import { createAuthor, getAuthor, updateAuthor, deletetAuthor, getAuthorDetails } from '../../api/index'
const validationSchema = yup.object().shape({
    authorName: yup.string().required("Author name is required").matches('^[a-zA-Z0-9 ]*$', "Publisher name not valid"),
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <div className="input-group mb-3">
                                    ...
                                    <input type="text" className="form-control" placeholder="Search by author name" onChange={(e) => { handleSearch(e.target.value) }} />
                                </div>
                                            ...
                                            <tr key={author._id}>
                                                ...
                                                <td className="py-2">
                                                    <Button size="sm" variant="info" className="m-2" >
                                                        <i className="fa fa-eye" aria-hidden="true" onClick={() => { handleShowDetails(author._id) }}>Details</i>
                                                    </Button>
                                                    <Button size="sm" variant="primary" className="m-2">
                                                        <i className="fa fa-pencil-square" aria-hidden="true" onClick={() => { handleShowEdit(author._id) }}>Edit</i>
                                                    </Button>

                                                    <Button size="sm" variant="danger" className="ml-2">
                                                        <i className="fa fa-trash" aria-hidden="true" onClick={() => { confirmDelete(author._id) }}>Delete</i>
                                                    </Button>
                                                </td>
                                            </tr>
                                        ))}
                            ...
                            {props => (
                                <form className="form-horizontal" onSubmit={props.handleSubmit}>
                                    <div className="row form-group">
                                        <div className="col col-md-3"><label htmlFor="author-name-input" className=" form-control-label">Publisher Name</label></div>
                                        <div className="col-12 col-md-9">
                                            <Form.Control
                                                ...
                                                isInvalid={props.touched.authorName && props.errors.authorName}
                                            />
                                            <Form.Control.Feedback type="invalid"></Form.Control.Feedback>
                                        </div>
                                        <small style={{ color: '#ff4d4d' }}>{props.touched.authorName && props.errors.authorName}</small>
                                    </div>
                                    <div className="row form-group">
                                        <div className="col col-md-3"><label htmlFor="author-name-input" className=" form-control-label">Day Of Birth</label></div>
                                        <div className="col-12 col-md-9">
                                            <Form.Control
                                        ...
                                        <small style={{ color: '#ff4d4d' }}>{props.touched.dob && props.errors.dob}</small>
                                    </div>
                                    <Modal.Footer>
                    ...
                    <div className="card-body card-block">
                        ...
                        >
                            {props => (
                                <form className="form-horizontal" onSubmit={props.handleSubmit}>
                                    <div className="row form-group">
                                        <div className="col col-md-4"><label htmlFor="author-name-input" className=" form-control-label">Publisher Name</label></div>
                                    ...
                                    <div className="row form-group">
                                        <div className="col col-md-4"><label htmlFor="author-name-input" className=" form-control-label">Day Of Birth</label></div>
                                        <div className="col-12 col-md-8">
                                            <label>{moment(props.values.dob).format('YYYY-MM-DD')}</label>
                                        </div>
                                    </div>
                                    <div className="row form-group">
                                        <div className="col col-md-4"><label htmlFor="author-name-input" className=" form-control-label">Day Of Birth</label></div>
                ...
                <Modal.Body className="show-grid">
                    <Container>
                        <Row>
                            ...
                            <Col xs={12} md={8}>{authorDetail._id}</Col>
                        </Row>

                        <Row>
                            <Col xs={6} md={4}>Author Name</Col>
                            <Col xs={12} md={8}>{authorDetail.authorName}</Col>
                        </Row>
                        <Row>
                            <Col xs={6} md={4}>Day Of Birth</Col>
                            <Col xs={12} md={8}>{moment(authorDetail.dob).format('YYYY-MM-DD')}</Col>
                        </Row>
                    </Container>
                </Modal.Body>
                <Modal.Footer>
